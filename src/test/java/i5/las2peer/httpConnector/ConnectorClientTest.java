...
public class ConnectorClientTest {
	...
	@Test
	public void testParameters() throws UnableToConnectException, AuthenticationFailedException, TimeoutException,
			ServerErrorException, AccessDeniedException, NotFoundException, ConnectorClientException {
		Client c = new Client(HTTP_ADDRESS, HTTP_PORT);
	...
	/**
	 * simple test with anonymous connection, three basic invocations, and disconnection
	 *
	 */
	@Test
	...
	public void testStringArray() {
		...
		params = new String[] { "<hmm><xmltest>blablebla\n</xmltest>\n\t\t</hmm>\n", "Hallo", "wach",
	...
	@Test
	public void testTouch() throws AuthenticationFailedException, UnableToConnectException, InterruptedException,
